...
public class Toolbar extends androidx.appcompat.widget.Toolbar
    ...
    private static int[] strokeIds = new int[]{
            R.styleable.Toolbar_carbon_stroke,
            R.styleable.Toolbar_carbon_strokeWidth
    };
    private static int[] cornerCutRadiusIds = new int[]{
            R.styleable.Toolbar_carbon_cornerRadiusTopStart,
            R.styleable.Toolbar_carbon_cornerRadiusTopEnd,
            R.styleable.Toolbar_carbon_cornerRadiusBottomStart,
            R.styleable.Toolbar_carbon_cornerRadiusBottomEnd,
            R.styleable.Toolbar_carbon_cornerRadius,
            R.styleable.Toolbar_carbon_cornerCutTopStart,
            R.styleable.Toolbar_carbon_cornerCutTopEnd,
            R.styleable.Toolbar_carbon_cornerCutBottomStart,
            R.styleable.Toolbar_carbon_cornerCutBottomEnd,
    ...
    private static int[] elevationIds = new int[]{
            ...
            R.styleable.Toolbar_carbon_elevationAmbientShadowColor,
            R.styleable.Toolbar_carbon_elevationSpotShadowColor
    };
