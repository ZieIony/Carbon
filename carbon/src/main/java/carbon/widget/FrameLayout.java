...
public class FrameLayout extends android.widget.FrameLayout
    ...
    private static int[] cornerCutRadiusIds = new int[]{
            R.styleable.FrameLayout_carbon_cornerRadiusTopStart,
            R.styleable.FrameLayout_carbon_cornerRadiusTopEnd,
            R.styleable.FrameLayout_carbon_cornerRadiusBottomStart,
            R.styleable.FrameLayout_carbon_cornerRadiusBottomEnd,
            R.styleable.FrameLayout_carbon_cornerRadius,
            R.styleable.FrameLayout_carbon_cornerCutTopStart,
            R.styleable.FrameLayout_carbon_cornerCutTopEnd,
            R.styleable.FrameLayout_carbon_cornerCutBottomStart,
            R.styleable.FrameLayout_carbon_cornerCutBottomEnd,
    ...
    private static int[] elevationIds = new int[]{
            ...
            R.styleable.FrameLayout_carbon_elevationAmbientShadowColor,
