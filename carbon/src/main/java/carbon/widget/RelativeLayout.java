...
public class RelativeLayout extends android.widget.RelativeLayout
    ...
    private static int[] rippleIds = new int[]{
            R.styleable.RelativeLayout_carbon_rippleColor,
            R.styleable.RelativeLayout_carbon_rippleStyle,
            R.styleable.RelativeLayout_carbon_rippleHotspot,
            R.styleable.RelativeLayout_carbon_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.RelativeLayout_carbon_inAnimation,
            R.styleable.RelativeLayout_carbon_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.RelativeLayout_carbon_touchMargin,
            R.styleable.RelativeLayout_carbon_touchMarginLeft,
            R.styleable.RelativeLayout_carbon_touchMarginTop,
            R.styleable.RelativeLayout_carbon_touchMarginRight,
            R.styleable.RelativeLayout_carbon_touchMarginBottom
    };
    private static int[] insetIds = new int[]{
            R.styleable.RelativeLayout_carbon_inset,
            R.styleable.RelativeLayout_carbon_insetLeft,
            R.styleable.RelativeLayout_carbon_insetTop,
            R.styleable.RelativeLayout_carbon_insetRight,
    ...
    private static int[] cornerCutRadiusIds = new int[]{
            R.styleable.RelativeLayout_carbon_cornerRadiusTopStart,
            R.styleable.RelativeLayout_carbon_cornerRadiusTopEnd,
            R.styleable.RelativeLayout_carbon_cornerRadiusBottomStart,
            R.styleable.RelativeLayout_carbon_cornerRadiusBottomEnd,
            R.styleable.RelativeLayout_carbon_cornerRadius,
            R.styleable.RelativeLayout_carbon_cornerCutTopStart,
            R.styleable.RelativeLayout_carbon_cornerCutTopEnd,
            R.styleable.RelativeLayout_carbon_cornerCutBottomStart,
            R.styleable.RelativeLayout_carbon_cornerCutBottomEnd,
            R.styleable.RelativeLayout_carbon_cornerCut
    };
    ...
    private static int[] elevationIds = new int[]{
            R.styleable.RelativeLayout_carbon_elevation,
            R.styleable.RelativeLayout_carbon_elevationShadowColor,
            R.styleable.RelativeLayout_carbon_elevationAmbientShadowColor,
    ...
    public static class LayoutParams extends android.widget.RelativeLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            anchorView = a.getResourceId(R.styleable.RelativeLayout_Layout_carbon_layout_anchor, -1);
            anchorGravity = a.getInt(R.styleable.RelativeLayout_Layout_carbon_layout_anchorGravity, -1);
            if (a.hasValue(R.styleable.RelativeLayout_Layout_carbon_layout_marginHorizontal))
                leftMargin = rightMargin = a.getDimensionPixelSize(R.styleable.RelativeLayout_Layout_carbon_layout_marginHorizontal, 0);
            if (a.hasValue(R.styleable.RelativeLayout_Layout_carbon_layout_marginVertical))
                topMargin = bottomMargin = a.getDimensionPixelSize(R.styleable.RelativeLayout_Layout_carbon_layout_marginVertical, 0);
            a.recycle();
        }
