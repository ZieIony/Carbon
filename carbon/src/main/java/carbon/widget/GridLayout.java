...
public class GridLayout extends androidx.gridlayout.widget.GridLayout
    ...
    private static int[] strokeIds = new int[]{
            R.styleable.GridLayout_carbon_stroke,
            R.styleable.GridLayout_carbon_strokeWidth
    };
    private static int[] cornerCutRadiusIds = new int[]{
            R.styleable.GridLayout_carbon_cornerRadiusTopStart,
            R.styleable.GridLayout_carbon_cornerRadiusTopEnd,
            R.styleable.GridLayout_carbon_cornerRadiusBottomStart,
            R.styleable.GridLayout_carbon_cornerRadiusBottomEnd,
            R.styleable.GridLayout_carbon_cornerRadius,
            R.styleable.GridLayout_carbon_cornerCutTopStart,
            R.styleable.GridLayout_carbon_cornerCutTopEnd,
            R.styleable.GridLayout_carbon_cornerCutBottomStart,
            R.styleable.GridLayout_carbon_cornerCutBottomEnd,
    ...
    private static int[] elevationIds = new int[]{
            ...
            R.styleable.GridLayout_carbon_elevationAmbientShadowColor,
