...
public class CornerTreatment implements Cloneable {
     ...
     *
     * <p>CornerTreatments are assumed to have an origin of (0, 0) (i.e. they represent the
     * top-left
     * corner), and are automatically rotated and scaled as necessary when applied to other
     * corners.
     *
     ...
     *                      (fully) interpolated. Custom corner treatments can implement
     *                      interpolation to support shape transition between two arbitrary states.
     *                      Typically, a value of 0 indicates that the custom corner treatment is
     *                      not rendered (i.e. that it is a 90 degree angle), and a value of 1
     *                      indicates that the treatment is fully rendered. Animation between these
     *                      two values can "heal" or "reveal" a corner treatment.
