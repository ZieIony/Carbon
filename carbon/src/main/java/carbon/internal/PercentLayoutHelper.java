...
public class PercentLayoutHelper {
    ...
    public static PercentLayoutInfo getPercentLayoutInfo(Context context,
        ...
        float value = array.getFraction(R.styleable.Carbon_carbon_widthPercent, 1, 1,
                -1f);
        if (value != -1f) {
        ...
        value = array.getFraction(R.styleable.Carbon_carbon_marginLeftPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Carbon_carbon_marginTopPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Carbon_carbon_marginRightPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Carbon_carbon_marginBottomPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Carbon_carbon_marginStartPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Carbon_carbon_marginEndPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
