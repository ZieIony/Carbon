...
import pl.zielony.carbon.internal.ElevationComparator;
import pl.zielony.carbon.shadow.Shadow;
import pl.zielony.carbon.shadow.ShadowGenerator;
...
public class FrameLayout extends android.widget.FrameLayout implements ShadowView, OnGestureListener {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        cornerRadius = (int) a.getDimension(R.styleable.FrameLayout_carbon_cornerRadius, 0);
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        if (!isInEditMode()) {
            ...
            if (Build.VERSION.SDK_INT >= 11) {
                ...
                canvas.concat(pl.zielony.carbon.internal.ViewHelper.getMatrix(child));
            }
