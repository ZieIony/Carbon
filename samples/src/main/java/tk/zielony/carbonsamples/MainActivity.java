...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Picasso & Carbon", "Recycler & cards", "Buttons", "ListView with ripple", "Large shadow", "Roboto", "Text appearance",
        ...
        final Class[] activities = new Class[]{PicassoActivity.class, RecyclerCardsActivity.class, ButtonsActivity.class, ListRippleActivity.class,
        ...
        final boolean[] beta = new boolean[]{false, false, false, true,
