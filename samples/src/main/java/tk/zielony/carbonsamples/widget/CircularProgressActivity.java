...
public class CircularProgressActivity extends ThemedActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressBar progress2 = findViewById(R.id.progress2);
        ...
        final ProgressBar progress3 = findViewById(R.id.progress3);
        ...
        final ProgressBar progress4 = findViewById(R.id.progress4);
